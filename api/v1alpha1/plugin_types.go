...
const (
	...
	// OptionValueConfigFailedReason is set when option values could not be written to config map
	OptionValueConfigFailedReason greenhousemetav1alpha1.ConditionReason = "OptionValueConfigFailed"

	// OptionValueSecretResolveFailedReason is set when option values could not be resolved from secrets
	OptionValueSecretResolveFailedReason greenhousemetav1alpha1.ConditionReason = "OptionValueSecretResolveFailed"
)
