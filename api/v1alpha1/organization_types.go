...
type OrganizationSpec struct {
	...
	// ConfigMapKeyReferences allows for multiple references to different config maps.
	ConfigMapKeyReferences []ConfigMapKeyReference `json:"configMapKeyReferences,omitempty"`
}
