...
func convertStatusConditionsTo(srcStatusConditions v1alpha1.StatusConditions) v1alpha1.StatusConditions {
...
func convertStatusConditionsFrom(srcStatusConditions v1alpha1.StatusConditions) v1alpha1.StatusConditions {
	dstConditions := make([]v1alpha1.Condition, 0, len(srcStatusConditions.Conditions))
	for i, v := range srcStatusConditions.Conditions {
...
func convertConditionTo(srcCondition v1alpha1.Condition) v1alpha1.Condition {
...
func convertConditionFrom(srcCondition v1alpha1.Condition) v1alpha1.Condition {
	dstCondition := v1alpha1.Condition{
		Type:               v1alpha1.ConditionType(srcCondition.Type),
		Status:             srcCondition.Status,
		Reason:             v1alpha1.ConditionReason(srcCondition.Reason),
