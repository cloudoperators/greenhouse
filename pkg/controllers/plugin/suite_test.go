...
var _ = BeforeSuite(func() {
	...
	test.RegisterController("pluginBundle", (&PluginBundleReconciler{}).SetupWithManager)
	...
	test.RegisterWebhook("pluginPresetWebhook", admission.SetupPluginBundleWebhookWithManager)
