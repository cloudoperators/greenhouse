...
// CreateUpdateConnector provides a mock function with given fields: ctx, k8sClient, org, configByte, namespace
func (_m *MockDexter) CreateUpdateConnector(ctx context.Context, k8sClient client.Client, org *v1alpha1.Organization, configByte []byte, namespace string) error {
	ret := _m.Called(ctx, k8sClient, org, configByte, namespace)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, client.Client, *v1alpha1.Organization, []byte, string) error); ok {
		r0 = rf(ctx, k8sClient, org, configByte, namespace)
	} else {
		r0 = ret.Error(0)
	}
...
// CreateUpdateOauth2Client provides a mock function with given fields: ctx, k8sClient, org, namespace
func (_m *MockDexter) CreateUpdateOauth2Client(ctx context.Context, k8sClient client.Client, org *v1alpha1.Organization, namespace string) error {
	ret := _m.Called(ctx, k8sClient, org, namespace)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, client.Client, *v1alpha1.Organization, string) error); ok {
		r0 = rf(ctx, k8sClient, org, namespace)
	} else {
		r0 = ret.Error(0)
	}
