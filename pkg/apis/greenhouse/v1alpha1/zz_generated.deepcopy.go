...
func (in *AuthSecretConfig) DeepCopyInto(out *AuthSecretConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthSecretConfig.
func (in *AuthSecretConfig) DeepCopy() *AuthSecretConfig {
	if in == nil {
		return nil
	}
	out := new(AuthSecretConfig)
	in.DeepCopyInto(out)
	return out
}
