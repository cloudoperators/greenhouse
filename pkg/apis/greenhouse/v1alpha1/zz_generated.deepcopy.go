...
func (in *PluginPresetStatus) DeepCopyInto(out *PluginPresetStatus) {
	*out = *in
	...
	if in.PluginStatuses != nil {
		...
		*out = make([]PropagatedPluginStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PropagatedPluginStatus) DeepCopyInto(out *PropagatedPluginStatus) {
	*out = *in
	in.PluginStatus.DeepCopyInto(&out.PluginStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PropagatedPluginStatus.
func (in *PropagatedPluginStatus) DeepCopy() *PropagatedPluginStatus {
	if in == nil {
		return nil
	}
	out := new(PropagatedPluginStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SCIMConfig) DeepCopyInto(out *SCIMConfig) {
	*out = *in
	...
	in.BasicAuthPw.DeepCopyInto(&out.BasicAuthPw)
