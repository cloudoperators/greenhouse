...
func ValidateCreatePluginDefinition(_ context.Context, _ client.Client, o runtime.Object) (admission.Warnings, error) {
	...
	if err := validateHelmChartOrUIApplication(pluginDefinition); err != nil {
		return nil, err
	}
...
func validateHelmChartOrUIApplication(pluginDefinition *greenhousev1alpha1.PluginDefinition) error {
