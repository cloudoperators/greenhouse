...
//go:build pluginpresetE2E

package pluginpreset
...
import (
	...
	"github.com/cloudoperators/greenhouse/e2e/pluginpreset/scenarios"
...
const (
	remoteClusterName = "remote-pluginpreset-cluster"
)
...
func TestE2e(t *testing.T) {
	...
	RunSpecs(t, "PluginPreset E2E Suite")
}
...
var _ = BeforeSuite(func() {
	...
	team = test.NewTeam(ctx, "test-pluginpreset-e2e-team", env.TestNamespace, test.WithTeamLabel(greenhouseapis.LabelKeySupportGroup, "true"))
...
var _ = Describe("PluginPreset E2E", Ordered, func() {
	...
	It("should have a cluster resource created and ready", func() {
	...
	It("should resolve cross-Plugin references by name", func() {
		scenarios.PluginPresetCrossPluginNameReference(ctx, adminClient, remoteClient, env, remoteClusterName, team.Name)
	})
