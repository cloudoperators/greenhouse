...
func ValidatePluginOptionValuesForPreset(pluginPreset *greenhousev1alpha2.PluginPreset, pluginDefinitionName string, pluginDefinitionSpec greenhousemetav1alpha1.PluginDefinitionTemplateSpec) field.ErrorList {
