...
func (r *ClusterPluginDefinitionReconciler) SetupWithManager(name string, mgr ctrl.Manager) error {
	...
	return setupManagerBuilder(
		...
		r.helmRepoAndChartEventHandler,
	).Complete(r)
}
...
func (r *ClusterPluginDefinitionReconciler) helmRepoAndChartEventHandler(_ context.Context, obj client.Object) []ctrl.Request {
	return enqueueOwnersForHelmRepoAndChart(obj, greenhousev1alpha1.ClusterPluginDefinitionKind)
}
