...
func (r *PluginDefinitionReconciler) helmRepoAndChartEventHandler(_ context.Context, obj client.Object) []ctrl.Request {
	return enqueueOwnersForHelmRepoAndChart(obj, greenhousev1alpha1.PluginDefinitionKind)
}
