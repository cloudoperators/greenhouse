...
func (r *PluginReconciler) EnsureFluxDeleted(ctx context.Context, plugin *greenhousev1alpha1.Plugin) (ctrl.Result, lifecycle.ReconcileResult, error) {
	...
	plugin.SetCondition(greenhousemetav1alpha1.TrueCondition(greenhousev1alpha1.HelmReleaseDeployedCondition, "", ""))
...
func (r *PluginReconciler) fetchReleaseStatus(ctx context.Context,
	...
	if pluginDefinitionSpec.HelmChart == nil {
		...
		pluginStatus.HelmReleaseStatus = nil
	...
	if err != nil {
		...
		if ready == nil {
			...
			case metav1.ConditionTrue:
				plugin.SetCondition(greenhousemetav1alpha1.TrueCondition(greenhousev1alpha1.HelmReleaseDeployedCondition, "", ready.Message))
			case metav1.ConditionFalse:
				plugin.SetCondition(greenhousemetav1alpha1.FalseCondition(greenhousev1alpha1.HelmReleaseDeployedCondition, "", ready.Message))
