...
const (
	...
	flagRenewRemoteClusterBearerTokenAfter = "renew-remote-cluster-bearer-token-after"
...
func main() {
	...
	flag.DurationVar(&retryPeriod, flagRetryPeriod, 10*time.Second, "Leader election retry period")
