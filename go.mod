...
replace (
	...
	github.com/dexidp/dex => github.com/dexidp/dex v0.0.0-20251023092925-7e2225c0e659
	github.com/dexidp/dex/api/v2 => github.com/dexidp/dex/api/v2 v2.4.0

	// Keep Flux dependencies in sync with v2.6.1.
	github.com/fluxcd/helm-controller/api => github.com/fluxcd/helm-controller/api v1.5.0
	github.com/fluxcd/kustomize-controller/api => github.com/fluxcd/kustomize-controller/api v1.8.0
